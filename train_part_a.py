...
# train groups 1 through 4 using standard dqn with varying reward shaping
def train_part_a(num_episodes=10000):
    ...
    print("\npart a training complete, results saved to results/part_a_training_results.pkl")
    return results


if __name__ == '__main__':
    num_episodes = int(sys.argv[1]) if len(sys.argv) > 1 else 10000
    train_part_a(num_episodes)
